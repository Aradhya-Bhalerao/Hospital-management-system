...
<html>
    ...
    <body>
        ...
        <div class="tabs">
            <a href="receptionist-dashboard.jsp" class="tab-link active">Go Back To Dashboard</a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><select name="doctor">
                                    ...
                                    %>
<!--<option value='<% // out.print(rs1.getString("name") + " (" + rs1.getString("education") + ")"); %>'>-->
<option value='<%=rs1.getString("name")%>'>
    <% out.print(rs1.getString("name") + " (" + rs1.getString("education") + ")"); %>
                        ...
                        <tr>
                            <td>Hospital Fees:</td>
                            <td><input type="text" name="fees"  id="fees" value=""></td>
                        </tr>
                        <tr>
