    ...
    <div class="container">
        <div style="display:flex; flex-direction: row;">
            <div>
                ...
                <form action="addNewReceptionist.jsp?action=update" method="post">
            ...
            <div>
                ...
                <form action="addNewReceptionist.jsp?action=add" method="post">
                    <div class="heading">Add New Receptionist</div>
                    <div class="box">
                ...
                if (request.getMethod().equalsIgnoreCase("post")) {
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        try {
                            ...
                            String selectQuery = "SELECT * FROM receptionistlogin WHERE User=? AND Password=?";
                            ...
                            if (rs.next()) {
                                String updateQuery = "UPDATE receptionistlogin SET User=?, Password=? WHERE User=?";
                        ...
                        // Retrieve form parameters for adding receptionist
                        ...
                        try {
                            ...
                            String insertQuery = "INSERT INTO receptionistlogin (User, Password) VALUES (?, ?)";
