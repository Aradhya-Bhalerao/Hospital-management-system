        ...
        <div class="container">
            ...
            <%
                ...
                try {
                    ...
                    ResultSet rs = stmt.executeQuery("SELECT * FROM patientreg where status='Online' ORDER BY timestamp ");
            %>
            ...
            <div style="display:flex; justify-content: space-around; width: 100%; flex-direction: row; ">
                ...
                <a href="PatientReg.jsp" name="print" style="text-decoration: none; color: #007bff; font-weight: bold; border: 1px solid #007bff; padding: 8px 16px; border-radius: 4px; background-color: #f8f9fa;">Register Patient Offline</a>
            ...
            <table>
                ...
                while (rs.next()) {%>
                    <tr>
                        ...
                        <td><a style="display:flex; justify-content: center; align-items: center; width:auto; border: 1px solid black; border-radius: 10px; text-decoration: none; background-color: #ccff99; color:black;" href='onlinepatientreg.jsp?id=<%=rs.getInt("id")%>'>Fill Details</a></td>
